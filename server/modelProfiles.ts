...
export const MODEL_FAMILY_CONFIGS: Record<string, ModelPromptConfig> = {
  ...
  deepseek: {
    ...
    defaultRole: 'coder',
    quirks: [
      'V4 Flash/Pro official API lists 1M context and up to 384K max output',
      'Empty assistant turn before tool call — check tool_calls first',
      'Official V4 feature table does not list native image input; keep vision disabled unless using a specific VL/provider variant',
