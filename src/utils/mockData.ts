...
export const mockTerminalCommands: TerminalCommand[] = [
  {
    ...
    exitCode: 0,
    duration: 4200,
    workingDir: '/Users/kevink/Projects/CMDui',
  },
  {
    id: uid(),
...
export const mockMemoryEntries: MemoryEntry[] = [
  ...
  { id: uid(), type: 'context', name: 'Project Context', path: '/Users/kevink/Projects/CMDui', description: 'Current working directory and repo state', lastAccessed: new Date() },
    ...
    toolCalls: [
      {
        ...
        name: 'exec_command',
        status: 'complete',
        input: 'find /Users/kevink/Projects/CMDui -type f',
      ...
      },
      {
        ...
        output: 'Scaffolding project in /Users/kevink/Projects/CMDui...',
        duration: 2400,
      },
    ],
  },
...
export const mockSessions: Session[] = [
  {
    id: uid(),
    title: 'Build CMDui - Codex Desktop UI',
