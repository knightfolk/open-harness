...
const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { id: 'anthropic', name: 'Anthropic', type: 'anthropic', baseURL: 'https://api.anthropic.com/v1', description: 'Claude Sonnet 4, Claude Opus 4', color: '#d4a574', featured: true },
  { id: 'google', name: 'Google', type: 'google', baseURL: 'https://generativelanguage.googleapis.com/v1beta', description: 'Gemini 2.5 Pro, Gemini 2.5 Flash', color: '#4285f4', featured: true },
...
const roleIconMap: Record<string, typeof Bot> = {
  planning: Brain, implementation: FileCode, bugfix: Wrench, design: Palette,
  image: Image, toolrunning: PlayCircle, review: ShieldCheck,
};
      ...
      <div className="settings-modal">
        ...
        <div className="settings-modal-body">
          ...
          <div className="settings-content">
            ...
            {contentKey === 'mcp/docker' && <DockerMCPPane mcpServers={mcpServers} mcpStatus={mcpStatus} />}
...
function DockerMCPPane({ mcpServers, mcpStatus }: any) {
...
function AboutPane() {
  return (
    <>
      <PaneTitle>About Open-Harness</PaneTitle>
      <PaneDesc>A universal AI provider harness for desktop.</PaneDesc>
      <div className="settings-card" style={{ marginTop: 16 }}>
        <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4 }}>Open-Harness</div>
