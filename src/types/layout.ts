export type PanelId = 'chat' | 'diffs' | 'browser' | 'terminal' | 'sub-agents' | 'plan' | 'files';
...
export const ALL_PANELS: PanelId[] = ['chat', 'diffs', 'browser', 'terminal', 'sub-agents', 'plan', 'files'];
