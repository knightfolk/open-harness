export type PanelId = 'chat' | 'side-chat' | 'diffs' | 'browser' | 'terminal' | 'sub-agents' | 'plan' | 'files' | 'model-lab';
...
export const ALL_PANELS: PanelId[] = ['chat', 'side-chat', 'diffs', 'browser', 'terminal', 'sub-agents', 'plan', 'files', 'model-lab'];
