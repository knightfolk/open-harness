...
const RAW_BUILTIN_THEME_REGISTRY: ThemeRegistry = [
  {
    ...
    quality: {
      contrastPairs: [
        { foreground: '#e8eaed', background: '#0e1116', minimumRatio: 4.5 },
        { foreground: '#a2a8b2', background: '#15181e', minimumRatio: 3 },
        { foreground: '#6366f1', background: '#0e1116', minimumRatio: 3 },
      ],
    ...
    tokens: {
      ...
      // Surface ramp retuned for depth: a deeper canvas plane, lifted chrome,
      // and elevated cards that float without needing hard vertical rules.
      surface: {
        primary: '#0e1116',
        secondary: '#15181e',
        tertiary: '#1b1f26',
      ...
      chat: {
        userBubble: '#4f52b5',
        userBubbleText: '#f3f4fb',
        assistantBubble: '#1b1f26',
